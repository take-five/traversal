...
Now let's create a <tt>traversal description</tt>.
  require 'traversal'
...
It's a minimal traversal description. It has <tt>start node</tt> and <tt>relation</tt> pointer (<code>children</code>, in this case).
